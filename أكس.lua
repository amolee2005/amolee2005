...
IP = io.popen("dig +short myip.opendns.com @X00T5resolver1.opendns.com"):read('*a'):gsub('[\n\r]+', '')
...
if not database:get(id_server..":7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q") then
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\27')
local 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q = io.read()
if 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/getMe')
if res ~= 200 then
print('\27[0;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n27[0;39;49m')
local json = JSON.decode(url)
database:set(id_server..":7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q_username","@X00T5"..json.result.username)
database:set(id_server..":7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q",7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q)
end 
else
print('\27[0;35m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua أكس.lua')
end
if not database:get(id_server..":1676423906:ID") then 
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ↓ :\na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\27[0;33;49m') 
local 1676423906ID = io.read() 
if 1676423906ID ~= '' then 
io.write('\27[1;35m تم حفظ ايدي المطور الاساسي \na┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n27[0;39;49m') 
database:set(id_server..":1676423906:ID",1676423906ID) 
else 
print('\27[0;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره') 
end  
os.execute('lua أكس.lua') 
end
if not database:get(id_server..":1676423906:USERNAME") then
io.write('\27[1;31m ↓ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
local 1676423906USERNAME = io.read():gsub('@X00T5','')
if 1676423906USERNAME ~= '' then
io.write('\n\27[1;34m تم حفظ معرف المطور :\n\27[0;39;49m')
database:set(id_server..":1676423906:USERNAME",'@X00T5'..1676423906USERNAME)
else
...
config = {
7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q = database:get(id_server..":7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q"),
1676423906 = database:get(id_server..":1676423906:ID"),
UserName = database:get(id_server..":1676423906:USERNAME"),
 }
...
print('\n\27[1;34m Welcome to the all-new and powerful Source أكس ')
file = io.open("أكس", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/أكس
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./أكس.lua -p PROFILE --bot=$7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q
done
]])  
file:close()  
file = io.open("BK", "w")  
...
f:close()  
database:del(id_server..":7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q")
database:del(id_server..":1676423906:ID")
end  
...
> CH › @X00T5
> DEVELOPER › @X00T5JJEJJ
]])
sudos = dofile("./Info.lua") 
1676423906 = tonumber(sudos.1676423906)
sudo_users = {1676423906}
bot_id = sudos.7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q:match("(%d+)")  
7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q = sudos.7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q 
--- start functions ↓
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir lllHzbot") 
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls lllHzbot'):lines() do
if v:match(".lua$") then
i = i + 1
...
sudo_users = {1676423906,1676423906}   
...
if hash or SudoBot(msg) or DevأكسW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevأكسW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevأكسW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevأكسW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevأكسW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevأكسW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevأكسW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1676423906) then
var = true  
elseif tonumber(user_id) == tonumber(1676423906) then
var = true  
...
local url , res = https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/getchatmember?chat_id="..database:get(bot_id..'add:ch:id').."&user_id="..User);
...
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/restrictChatMember?chat_id="..Chat_id.."&user_id="..User_id)
end
function s_api(web) 
local info, res = https.request(web) local req = json:decode(info) if res ~= 200 then return false end if not req.ok then return false end return req 
end 
local function sendText(chat_id, text, reply_to_message_id, markdown) 
send_api = "https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q local url = send_api..'/sendMessage?chat_id=' .. chat_id .. '&text=' .. URL.escape(text) if reply_to_message_id ~= 0 then url = url .. '&reply_to_message_id=' .. reply_to_message_id  end if markdown == 'md' or markdown == 'markdown' then url = url..'&parse_mode=Markdown' elseif markdown == 'html' then url = url..'&parse_mode=HTML' end return s_api(url)  
end
...
local response = {} response.keyboard = keyboard response.inline_keyboard = inline response.resize_keyboard = true response.one_time_keyboard = false response.selective = false  local send_api = "https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/sendMessage?chat_id="..chat_id.."&text="..URL.escape(text).."&parse_mode=Markdown&disable_web_page_preview=true&reply_markup="..URL.escape(JSON.encode(response)) if reply_id then send_api = send_api.."&reply_to_message_id="..reply_id end return s_api(send_api) 
end
...
local UserName = (data.username_ or "xo0t1")
...
local Chek_Info = https.request('https://api.telegram.org/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/getChatMember?chat_id='.. chat ..'&user_id='.. user..'')
...
File:write(t)
File:close()
sendDocument(1676423906, 0,0, 1, nil, './'..bot_id..'.json', '- عدد كروبات التي في البوت { '..#list..'}')
end
...
local File = json:decode(https.request('https://api.telegram.org/bot'.. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/getfile?file_id='..ID_FILE)) 
download_to_file('https://api.telegram.org/file/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/'..File.result.file_path,File_Name) 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil,'./'..File_Name,'تم تحويل الملصق الى صوره')     
os.execute('rm -rf ./'..File_Name) 
end
function Addvoi(msg,chat,vi,ty)
local eq = json:decode(https.request('https://api.telegram.org/bot'.. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/getfile?file_id='..vi)) 
download_to_file('https://api.telegram.org/file/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/'..eq.result.file_path,ty) 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, './'..ty)   
os.execute('rm -rf ./'..ty) 
end
function Addmp3(msg,chat,kkl,ffrr)
local eer = json:decode(https.request('https://api.telegram.org/bot'.. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/getfile?file_id='..kkl)) 
download_to_file('https://api.telegram.org/file/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/'..eer.result.file_path,ffrr) 
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@X00T5VVVZVV")  
os.execute('rm -rf ./'..ffrr) 
end
function Addsticker(msg,chat,Sd,rre)
local Qw = json:decode(https.request('https://api.telegram.org/bot'.. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/getfile?file_id='..Sd)) 
download_to_file('https://api.telegram.org/file/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/'..Qw.result.file_path,rre) 
sendSticker(msg.chat_id_, msg.id_, 0, 1, nil, './'..rre)
os.execute('rm -rf ./'..rre) 
end
function AddlllHzbot(msg,chat,ID_FILE,File_Name)
...
if type == 'keed' then
https.request("https://api.telegram.org/bot" .. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..msg.sender_user_id_.."") 
...
--------------------------------------------------------------------------------------------------------------
function Sourceأكس(msg,data) -- بداية العمل
if msg then
...
Sourceأكسr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الكروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://t.me/xo0t1)'
end 
send(msg.chat_id_, msg.id_, Sourceأكسr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevأكسW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
send(msg.sender_user_id_, msg.id_,' ❃∫ تم ارسال رسالتك\n ❃∫ سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = 1676423906,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' ❃∫ تم ارسال الملصق من ↓\n - '..Name
sendText(1676423906,Text,0,'md')
end 
end,nil) 
end,nil)
end
if DevأكسW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
sendText(1676423906,Text,msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,أكس_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevأكسW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevأكسW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevأكسW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevأكسW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevأكسW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevأكسW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevأكسW(msg) then 
...
if text == 'تحديث السورس ❃' and DevأكسW(msg) then 
os.execute('rm -rf أكس.lua')
os.execute('wget https://raw.githubusercontent.com/أكسTEAM/أكس/master/أكس.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس بويكا\n ❃∫ الاصدار » { 6.7v}')
dofile('أكس.lua')  
end
if text == 'تحديث المتجر ❃' and DevأكسW(msg) then 
  io.popen("mkdir lllHzbot")
  io.popen("cd lllHzbot && rm -rf ga.lua.1") 
  io.popen("cd lllHzbot && rm -rf ga.lua.2") 
  io.popen("cd lllHzbot && rm -rf ga.lua.3") 
  io.popen("cd lllHzbot && wget https://raw.githubusercontent.com/أكسTEAM/Files_أكس/master/lllHzbot/ga.lua")  
  io.popen("cd lllHzbot && wget https://raw.githubusercontent.com/أكسTEAM/Files_أكس/master/lllHzbot/rd.lua") 
  send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث \n ❃∫ لديك اخر اصدار للمتجر')
  dofile('أكس.lua')  
  end
if text == 'رقم البناء ❃' and DevأكسW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اهلاء عزيزي \n رقم البناء خاص بوتك {lua~{m7a29}')
end
if text == 'الاصدار ❃' and DevأكسW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس بويكا \n ❃∫ الاصدار »{ 6.7v}')
  end
  if text == 'مطور السورس ❃' and DevأكسW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' ❃∫ تنويه : قبل لا تراسل المطور تاكد انو عندك شغله مهمه \n\n المطور - @X00T5JJEJJ ')
    end
if text == 'قناه تحديثات البوت ❃' and DevأكسW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/xo0t1) \n ❃∫ [قناه السورس](t.me/xo0t1)')
end
if text == "ضع اسم للبوت ❃" and DevأكسW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevأكسW(msg) then 
...
if text == 'المشتركين ❃' and DevأكسW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❃' and DevأكسW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevأكسW(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n ❃∫ قائمة المطورين \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@X00T5"..username.."])\n"
else
t = t..""..k.."- ("..v..")\n"
end
end
...
if text == ("قائمه العام ❃") and DevأكسW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevأكسW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevأكسW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevأكسW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevأكسW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevأكسW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevأكسW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevأكسW(msg) then 
GetlllHzbot(msg)
end
if text == "تنظيف المشتركين ❃" and DevأكسW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ❃" and DevأكسW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..أكسk..''..أكس..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @X00T5(.*)$") and DevأكسW(msg) then
local username = text:match("^رفع مطور @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'xo0t1')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevأكسW(msg) then
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xo0t1')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @X00T5(.*)$") and DevأكسW(msg) then
local username = text:match("^تنزيل مطور @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مطور (%d+)$") and DevأكسW(msg) then
...
local أكس1_Msg = database:get(bot_id.."أكس1:Add:Filter:Rp2"..text..msg.chat_id_)   
if أكس1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xo0t1')..') \n ❃∫ '..أكس1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
return false  end 
database:del(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
local username = string.match(text, "@X00T5[%a%d_]+") 
tdcli_function ({    
ID = "SearchPublicChat",    
username_ = username  
},function(arg,data) 
...
send(msg.chat_id_, msg.id_,' ❃∫ البوت ادمن في القناة \n ❃∫ تم تفعيل الاشتراك الاجباري في \n ❃∫ ايدي القناة ('..data.id_..')\n ❃∫ معرف القناة ([@X00T5'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@X00T5'..data.type_.channel_.username_)
else
...
t = t:gsub('user',('@X00T5'..result.username_ or 'لا يوجد')) 
send(msg.chat_id_, msg.id_,'['..t..']')
end,nil) 
end 
end 
...
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
...
--------------------------------------------------------------------------------------------------------------
if أكس_Msg and not Special(msg) then  
local أكس_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if أكس_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..أكس_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](t.me/xo0t1)}\n ❃∫ ["..أكس_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if msg.content_.caption_:match("@X00T5[%a%d_]+") or msg.content_.caption_:match("@X00T5(.+)") then  
...
--------------------------------------------------------------------------------------------------------------
if text and text:match("@X00T5[%a%d_]+") or text and text:match("@X00T5(.+)") then    
if database:get(bot_id.."lock:user:name"..msg.chat_id_) == "del" and not Special(msg) then    
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
elseif database:get(bot_id.."lock:user:name"..msg.chat_id_) == "ked" and not Special(msg) then    
ked(msg.chat_id_,msg.sender_user_id_)
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " ❃∫ عذرا » {[@X00T5"..data.username_.."]}\n ❃∫ عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](t.me/xo0t1)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevأكسW(msg) then
...
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/exportChatInviteLink?chat_id='..msg.chat_id_))
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevأكسW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevأكسW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevأكسW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevأكسW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevأكسW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevأكسW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevأكسW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevأكسW(msg) then  
...
database:sadd(bot_id.."أكس:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."أكس:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_أكس = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_أكس then 
names_أكس = database:smembers(bot_id.."أكس:blocname"..msg.chat_id_) or ""
if names_أكس and names_أكس[1] then 
for i=1,#names_أكس do 
if name_أكس:match("(.*)("..names_أكس[i]..")(.*)") then 
...
database:set(bot_id.."أكس:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."أكس:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."أكس:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."أكس:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."أكس:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_أكسa_new(أكس1,أكس2)
if أكس2 and أكس2.first_name_ then 
if أكس2.first_name_:match("(.*)"..database:get(bot_id.."أكس:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."أكس:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local أكس_nnn = database:get(bot_id.."أكس:nump"..msg.chat_id_) or 5
local أكس_nnn2 = database:get(bot_id.."أكس:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(أكس_nnn2) == tonumber(أكس_nnn) or tonumber(أكس_nnn2) > tonumber(أكس_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."أكس:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..أكس2.username_.."](https://t.me/"..(أكس2.username_ or "xo0t1")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."أكس:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(أكس_nnn) - tonumber(أكس_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_أكسa_new)
end
end
...
local أكسChengName = database:get(bot_id.."أكس:Cheng:Name"..data.id_)
if not data.first_name_ then 
if أكسChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..أكسChengName..']')
database:del(bot_id.."أكس:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if أكسChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."أكس:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local أكسChengUserName = database:get(bot_id.."أكس:Cheng:UserName"..data.id_)
if not data.username_ then 
if أكسChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@X00T5"..أكسChengUserName..']')
database:del(bot_id.."أكس:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if أكسChengUserName ~= data.username_ then 
local Text = {
'شكو غيرت معرفك شنو نشروك بقنوات فضايح😂🥺',
"هاها شو غيرت معرفك بس لا هددتك/ج الحب",
"شسالفه شو غيرت معرفك 😐🌝",
"غير معرفه خمطو بساع بساع \n هاذه معرفه : @X00T5"..data.username_.."",
'ها عار مو جان معرفك \n شكو غيرته ل @X00T5'..data.username_..' ',
'ها يول شو مغير معرفك بيش مشتري يول', 
"منور معرف جديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."أكس:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local أكسChengPhoto = database:get(bot_id.."أكس:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if أكسChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."أكس:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if أكسChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."أكس:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevأكسW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
AddlllHzbot(msg,msg.chat_id_,ID_FILE,File_Name)
end   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xo0t1')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
Text = ' ❃∫ تم تفعيل امر @X00T5all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' ❃∫ بالتاكيد تم تفعيل امر @X00T5all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ❃∫ تم تعطيل امر @X00T5all'
else
Text = '\n ❃∫ بالتاكيد تم تعطيل امر @X00T5all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xo0t1')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevأكسW(msg) then    
dofile('أكس.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevأكسW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevأكسW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(1676423906) then
...
if text and text:match("^حظر عام @X00T5(.*)$")  and DevأكسW(msg) then
local username = text:match("^حظر عام @X00T5(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if result.id_ == tonumber(1676423906) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك حظر المطور الاساسي \n")
return false 
end
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'xo0t1')..')'
...
if text and text:match("^حظر عام (%d+)$") and DevأكسW(msg) then
...
if userid == tonumber(1676423906) then
send(msg.chat_id_, msg.id_, " ❃∫ لا يمكنك حظر المطور الاساسي \n")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevأكسW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @X00T5(.*)$")  and DevأكسW(msg) then
local username = text:match("^كتم عام @X00T5(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام (%d+)$") and DevأكسW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevأكسW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @X00T5(.*)$") and DevأكسW(msg) then
local username = text:match("^الغاء العام @X00T5(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام (%d+)$") and DevأكسW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevأكسW(msg) then
...
if text == "@X00T5all" and CoSu(msg) then
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
...
if text == 'الملفات' and DevأكسW(msg) then
...
if DevأكسW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/أكسTEAM/Files_أكس/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات بويكا\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝘽𝙆━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝘽𝙆━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس بويكا ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/xo0t1) \n"
local NumFile = 0
for name,Info in pairs(res.plugins_) do
local Check_File_is_Found = io.open("lllHzbot/"..name,"r")
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevأكسW(msg) then
local name_t = {string.match(text, "^(تعطيل) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("lllHzbot/"..file,"r")
if file_bot then
io.close(file_bot)
t = " ❃∫ الملف » "..file.."\n ❃∫ تم تعطيل ملف \n"
else
...
local json_file, res = https.request("https://raw.githubusercontent.com/أكسTEAM/Files_أكس/master/lllHzbot/"..file)
if res == 200 then
os.execute("rm -fr lllHzbot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('أكس.lua')  
else
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevأكسW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/أكسTEAM/Files_أكس/master/lllHzbot/"..file)
if res == 200 then
local chek = io.open("lllHzbot/"..file,'w+')
...
if text == "مسح الملفات" and DevأكسW(msg) then
os.execute("rm -fr lllHzbot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevأكسW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevأكسW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مالك @X00T5(.*)$") and Sudo(msg) then
local username = text:match("^رفع مالك @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مالك @X00T5(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل مالك @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
st = https.request('https://black-source.tk/BlackTeAM/ImageInfo.php?7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q='..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'&url='..sticker_id.."&type=sticker")
eker = JSON.decode(st)
...
Srrt = https.request('https://black-source.tk/BlackTeAM/ImageInfo.php?7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q='..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'&url='..photo_id.."&type=photo")
...
if text and text:match("^رفع منشئ اساسي @X00T5(.*)$") and CoSu(msg) then
local username = text:match("^رفع منشئ اساسي @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل منشئ اساسي @X00T5(.*)$") and CoSu(msg) then
local username = text:match("^تنزيل منشئ اساسي @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "xo0t1")
...
if text and text:match("^رفع منشئ @X00T5(.*)$") and BasicConstructor(msg) then
local username = text:match("^رفع منشئ @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text and text:match("^تنزيل منشئ @X00T5(.*)$") and BasicConstructor(msg) then
local username = text:match("^تنزيل منشئ @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مدير @X00T5(.*)$") and Constructor(msg) then
local username = text:match("^رفع مدير @X00T5(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مدير @X00T5(.*)$") and Constructor(msg) then
local username = text:match("^تنزيل مدير @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_أكس(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_أكس, nil)
return false 
end
if text and text:match("^رفع مطور ثانوي @X00T5(.*)$") and SudoBot(msg) then
local username = text:match("^رفع مطور ثانوي @X00T5(.*)$")
function Function_أكس(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"❃∫ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_أكس, nil)
return false 
end
...
if text and text:match("^تنزيل مطور ثانوي @X00T5(.*)$") and SudoBot(msg) then
local username = text:match("^تنزيل مطور ثانوي @X00T5(.*)$")
function Function_أكس(extra, result, success)
if result.id_ then
...
if text and text:match("^رف�� ادمن @X00T5(.*)$") and Manager(msg) then
local username = text:match("^رفع ادمن @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل ادمن @X00T5(.*)$") and Manager(msg) then
local username = text:match("^تنزيل ادمن @X00T5(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^طرد @X00T5(.*)$") and Mod(msg) then 
local username = text:match("^طرد @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مميز @X00T5(.*)$") and Mod(msg) then
local username = text:match("^رفع مميز @X00T5(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل مميز @X00T5(.*)$") and Mod(msg) then
local username = text:match("^تنزيل مميز @X00T5(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xo0t1')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xo0t1')..')'
...
if text and text:match("^حظر @X00T5(.*)$") and Mod(msg) then
local username = text:match("^حظر @X00T5(.*)$")
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' ❃∫ تم تعطيل الحظر') 
return false
end
...
if text and text:match("^الغاء حظر @X00T5(.*)$") and Mod(msg) then
local username = text:match("^الغاء حظر @X00T5(.*)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم @X00T5(.*)$") and Mod(msg) then
local username = text:match("^كتم @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
if text and text:match('^كتم (%d+) (.*) @X00T5(.*)$') and Mod(msg) then
local TextEnd = {string.match(text, "^(كتم) (%d+) (.*) @X00T5(.*)$")}
function start_function(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ❃∫ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
texts = usertext..status
send(msg.chat_id_, msg.id_,texts)
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_..'&until_date='..tonumber(msg.date_+Time))
end
end
end
...
if text and text:match("^الغاء كتم @X00T5(.*)$") and Mod(msg) then
local username = text:match("^الغاء كتم @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xo0t1')..')'
status  = '\n ❃∫ تم تقيده'
send(msg.chat_id_, msg.id_, usertext..status)
...
------------------------------------------------------------------------
if text and text:match("^تقيد @X00T5(.*)$") and Mod(msg) then
local username = text:match("^تقيد @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_)
...
if text and text:match('^تقيد (%d+) (.*) @X00T5(.*)$') and Mod(msg) then
local TextEnd = {string.match(text, "^(تقيد) (%d+) (.*) @X00T5(.*)$")}
function start_function(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," ❃∫ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
https.request("https://api.telegram.org/bot" .. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xo0t1')..')'
status  = '\n ❃∫ تم تقيده'
...
function start_function(extra, result, success)
https.request("https://api.telegram.org/bot" .. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.sender_user_id_ .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xo0t1')..')'
status  = '\n ❃∫ تم الغاء تقيد'
send(msg.chat_id_, msg.id_, usertext..status)
...
------------------------------------------------------------------------
if text and text:match("^الغاء تقيد @X00T5(.*)$") and Mod(msg) then
local username = text:match("^الغاء تقيد @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if result.id_ then
https.request("https://api.telegram.org/bot" .. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.id_ .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'xo0t1')..')'
status  = '\n ❃∫ تم الغاء تقيد'
texts = usertext..status
else
...
https.request("https://api.telegram.org/bot" .. 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..userid.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xo0t1')..')'
status  = '\n ❃∫ تم الغاء تقيد'
...
if text and text:match('^رفع القيود @X00T5(.*)') and Manager(msg) then 
local username = text:match('^رفع القيود @X00T5(.*)') 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match('^كشف القيود @X00T5(.*)') and Manager(msg) then 
local username = text:match('^كشف القيود @X00T5(.*)') 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
if text and text:match("^رفع مشرف @X00T5(.*)$") and Constructor(msg) then
local username = text:match("^رفع مشرف @X00T5(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ❃∫ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, ' ❃∫  لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
if text and text:match("^تنزيل مشرف @X00T5(.*)$") and Constructor(msg) then
local username = text:match("^تنزيل مشرف @X00T5(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ❃∫ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, '⚠¦ لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
if text and text:match("^رفع ادمن بكل الصلاحيات @X00T5(.*)$") and BasicConstructor(msg) then
local username = text:match("^رفع ادمن بكل الصلاحيات @X00T5(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ❃∫ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
else
send(msg.chat_id_, msg.id_, ' ❃∫  لا يوجد حساب بهاذا المعرف')
end
end
...
if text and text:match("^تنزيل ادمن بكل الصلاحيات @X00T5(.*)$") and BasicConstructor(msg) then
local username = text:match("^تنزيل ادمن بكل الصلاحيات @X00T5(.*)$")
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' ❃∫ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
https.request('https://api.telegram.org/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/unpinAllChatMessages?chat_id='..msg.chat_id_)
database:del(bot_id..'Pin:Id:Msg'..msg.chat_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," ❃∫ انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
...
local TEXT_1676423906 = database:get(bot_id..'TEXT_1676423906')
if TEXT_1676423906 then 
send(msg.chat_id_, msg.id_,TEXT_1676423906)
else
tdcli_function ({ID = "GetUser",user_id_ = 1676423906},function(arg,result) 
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
...
https.request('https://api.telegram.org/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/deleteChatPhoto?chat_id='..msg.chat_id_) 
...
database:set(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."أكس1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."أكس1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."أكس1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."أكس1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."أكس1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."أكس1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."أكس1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."أكس1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."أكس1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."أكس1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."أكس1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do  
local أكس_Msg = database:get(bot_id.."أكس1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..أكس_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevأكسW(msg) then
database:del(bot_id..'TEXT_1676423906')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevأكسW(msg) then
database:set(bot_id..'Set:TEXT_1676423906'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,' ❃∫ ارسل الكليشه الان')
return false
end
if text and database:get(bot_id..'Set:TEXT_1676423906'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' then 
database:del(bot_id..'Set:TEXT_1676423906'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' ❃∫ تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_1676423906',text)
database:del(bot_id..'Set:TEXT_1676423906'..msg.chat_id_..':'..msg.sender_user_id_)
...
text = text..">> [@X00T5"..ta.username_..']'..tr.."\n"
if #admins == 0 then
send(msg.chat_id_, msg.id_, " ❃∫ لا توجد بوتات في الكروب")
return false 
end
...
if text and text:match('^رفع (.*) @X00T5(.*)') and Mod(msg) then 
local text1 = {string.match(text, "^(رفع) (.*) @X00T5(.*)$")}
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'xo0t1')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text and text:match('^تنزيل (.*) @X00T5(.*)') and Mod(msg) then 
local text1 = {string.match(text, "^(تنزيل) (.*) @X00T5(.*)$")}
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل الاذاعه' and DevأكسW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevأكسW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..أكس_Msg[math.random(#أكس_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevأكسW(msg) then 
...
local t = "\nツ قائمة الاعضاء \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
x = 0
local list = أكس.members_
for k, v in pairs(list) do
x = x + 1
if database:get(bot_id..'user:Name'..v.user_id_) then
t = t..""..x.." → {[@X00T5"..database:get(bot_id..'user:Name'..v.user_id_).."]}\n"
else
t = t..""..x.." → {"..v.user_id_.."}\n"
end
end
...
function start_function(extra, result, success)
if tonumber(1676423906) == tonumber(result.sender_user_id_) then
...
if tonumber(1676423906) == tonumber(msg.sender_user_id_) then
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id..'Constructor'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevأكسW(msg) then 
...
if text == ("ردود المطور") and DevأكسW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝘽𝙆━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevأكسW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevأكسW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevأكسW(msg) then   
...
if text == 'تعطيل المغادره' and DevأكسW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'أكس')..') '
status  = '\n❃∫ تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/setChatAdministratorCustomTitle?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&custom_title="..timsh)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
local username = ('[@X00T5'..data.username_..']' or 'لا يوجد')
...
if text and text:match("^ايدي @X00T5(.*)$") then
local username = text:match("^ايدي @X00T5(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'xo0t1')..')'
local iduser = result.sender_user_id_
...
---------
if text and text:match("^الرتبه @X00T5(.*)$") then
local username = text:match("^الرتبه @X00T5(.*)$")
function start_function(extra, result, success)
if result.id_ then
tdcli_function ({ID = "GetUser",user_id_ = result.id_},function(extra,data) 
local rtp = Rutba(result.id_,msg.chat_id_)
...
---------
if text and text:match("^كشف @X00T5(.*)$") then
local username = text:match("^كشف @X00T5(.*)$")
function start_function(extra, result, success)
if result.id_ then
tdcli_function ({ID = "GetUser",user_id_ = result.id_},function(extra,data) 
local rtp = Rutba(result.id_,msg.chat_id_)
...
if result.id_ then
send(msg.chat_id_, msg.id_,' ❃∫ تعال حبي يصيحونك بل كروب [@X00T5'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
username = '@X00T5'..result.username_ 
else
username = 'لا يوجد '
end
...
-- vardump(data) 
أكسdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Chek_Info = https.request('https://api.telegram.org/bot'..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. bot_id..'')
local Json_Info = JSON.decode(Chek_Info)
if Json_Info.ok == true then
if Json_Info.result.status == "administrator" then
if Json_Info.result.can_change_info == true then
...
if text == 'استعاده الاوامر' and DevأكسW(msg) then
...
return false
  ...
  {
  {text = '𝐁𝐎𝐘𝐊𝐀 {𝐑} 𝐓𝐄𝐀𝐌', url="t.me/xo0t1"},
  },
  }
  local msg_id = msg.id_/2097152/0.5
  https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
  return false
  end
  ----------------------------------------
...
zh = https.request('https://rudi-dev.tk/Amir1/أكس.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝘽𝙆━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
gk = https.request('https://rudi-dev.tk/Amir2/أكس.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/أكس.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
------------------------------------------------------------------------
if text and text:match('^صلاحياته @X00T5(.*)') then   
local username = text:match('صلاحياته @X00T5(.*)')   
if tonumber(msg.reply_to_message_id_) == 0 then 
...
if data.ID == "UpdateNewCallbackQuery" then
  ...
  https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(notText).."&show_alert=true")
  return false
  end
  local Teext =[[
  ...
  return https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
  end
  if Text == '/help2' then
  if not Mod(data) then
  local notText = '🚫 عذرا الاوامر هذه لا تخصك'
...
https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
أكس = https.request("https://api.telegram.org/bot"..7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(أكس)
...
local users = ('[@X00T5'..data.username_..']' or iduser)
local list = database:smembers(bot_id..'Constructor'..msg.chat_id_)
...
------------------------------------------------------------------------
if text and text:match("(.*)(@X00T5)(.*)") then
...
------------------------------------------------------------------------
local أكسAbot = database:get(bot_id.."أكس1:Add:Filter:Rp2"..text..result.chat_id_)   
if أكسAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..أكسAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local أكس1_Msg = database:get(bot_id.."أكس1:Add:Filter:Rp2"..text..result.chat_id_)   
if أكس1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..أكس1_Msg)
...
infos = {} 
infos.sudoid = 1676423906
infos.sudouser  = database:get(id_server..":1676423906:USERNAME")
infos.userbot = database:get(id_server..":7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q_username")
infos.7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q  = 7992873040:AAE8ko7GNMgI9ECCZUZgMfgnxDSG5oLBV2Q
